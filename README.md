...
>
> Pasta de Documentação: Indisponível 📄
> 
...
|   3  |    Alta    | Como um vendedor, eu quero registrar o cadastro completo de clientes (nome, endereço, atividade, segmento, contatos, departamento) para centralizar as informações do contato.                                  |       5      |        |        |
|   4  |    Alta    | Como um vendedor, eu quero registrar o histórico completo de interações com os clientes (data, forma de contato, relatório detalhado) para acompanhar o relacionamento.                                         |       4      |        |        |
|   5  |    Alta    | Como um gerente, eu quero gerar relatórios e gráficos quantitativos sobre interações, vendas, e clientes (por cidade, segmento), com filtros de período (dia, mês, ano), para tomar decisões baseadas em dados. |       6      |        |        |
...
|  12  |    Média   | Como um gerente de vendas, eu quero visualizar e classificar os clientes em um funil de vendas (Prospects, Inicial, Potencial, Manutenção, Em Negociação, Follow Up) para gerenciar o processo comercial.       |       2      |        |        |
|  13  |    Média   | Como um vendedor, eu quero agendar tarefas e receber lembretes para próximos contatos com clientes, para não perder oportunidades de negócio.                                                                   |       8      |        |        |
|  14  |    Média   | Como um operador, eu quero preencher o checklist de "Abertura e fechamento da empresa" (sim/não) para registrar o cumprimento dos procedimentos diários.                                                        |       5      |        |        |
|  15  |    Média   | Como um operador, eu quero preencher o "Checklist de Agregado", inserindo dados do motorista, do veículo e fotos para formlizar a vistoria.                                                                     |       4      |        |        |
|  16  |    Média   | Como um operador, eu quero preencher o "Checklist de veículo da frota" (sim/não) para registrar a conformidade dos veículos.                                                                                    |       4      |        |        |
|  17  |    Média   | Como um responsável pela manutenção, eu quero preencher o checklist de "Manutenção predial" (excelente/bom/precisa reparo) para registrar as condições das instalações.                                         |       4      |        |        |
|  18  |    Baixa   | Como um gestor, eu quero consultar os eventos pendentes de confirmação e os já realizados pelos colaboradores, para ter um controle sobre a participação da equipe.                                             |       6      |        |        |
...
<div align="center">
  <table>
    ...
    <tr>
      ...
      <td><a href="https://www.linkedin.com/in/joaoomoura"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"></a></td>
    </tr>
    <tr>
