...
const formatarTelefone = (inputElement) => {
...
telInputCadastro.addEventListener('input', () => formatarTelefone(telInputCadastro));
telInputEdicao.addEventListener('input', () => formatarTelefone(telInputEdicao));
            ...
            <tbody>
                ${colaboradores.map(colab => `
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-primary btn-editar" data-id="${colab.ID_colaborador}">Editar</button>
                            <button class="btn btn-sm btn-danger btn-excluir" data-id="${colab.ID_colaborador}">Excluir</button>
                        </td>
                    </tr>
                `).join('')}
            </tbody>
...
const abrirModalEdicao = async (id) => {
    try {
        ...
        formatarTelefone(document.getElementById('edit-telefone'));
        edicaoModal.show(); 
    } catch (error) {
...
formCadastro.addEventListener('submit', async (e) => {
    ...
    const dados = {
        ...
        telefone: telInputCadastro.value.replace(/\D/g, ''),
        cpf: cpfInputCadastro.value.replace(/\D/g, ''),
